...
@WebServiceClient(name = "ProductCRUDWebService", 
                  ...
                  targetNamespace = "http://uebungen.esa/jws4") 
public class ProductCRUDWebService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://uebungen.esa/jws4", "ProductCRUDWebService");
    public final static QName ProductCRUDWebServicePort = new QName("http://uebungen.esa/jws4", "ProductCRUDWebServicePort");
    static {
        URL url = null;
        try {
